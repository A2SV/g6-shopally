                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('Alibaba', style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color)),
                              ],
                            ),
                            Row(
                              children: [
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    setState(() {
                      if (!isaddtocompare) {
                        // Enforce a maximum of 4 compared items
                        if (widget.compparedItems.length >= 4) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                getText('You can only compare up to 4 items.'),
                              ),
