...
func (h *ChatHandler) CreateChat(c *gin.Context) {
	...
	chatSession, err := h.chatService.CreateChat(c.Request.Context(), userEmail, req.ChatTitle)
	if err != nil {
...
func (h *ChatHandler) AddMessageToChat(c *gin.Context) {
	...
	if err := h.chatService.AddMessageToChat(c.Request.Context(), userEmail, chatID, req.UserPrompt, req.Products); err != nil {
...
func (h *ChatHandler) DeleteChat(c *gin.Context) {
	...
	if err := h.chatService.DeleteChat(c.Request.Context(), userEmail, chatID); err != nil {
		if appErrors.Is(err, appErrors.ErrNotFound) {
...
func (h *ChatHandler) GetChatSession(c *gin.Context) {
	...
	chat, err := h.chatService.GetChatSession(c.Request.Context(), userEmail, chatID)
	if err != nil {
		if appErrors.Is(err, appErrors.ErrNotFound) {
